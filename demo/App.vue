...
const PAGES = [
  ...
  },
  {
    ...
    links    : [
      { hash: 'textbox', label: 'GKTextBox' },
      { hash: 'textarea', label: 'GKTextArea' },
      { hash: 'selectbox', label: 'GKSelectBox' },
      { hash: 'checkbox', label: 'GKCheckBox 系' },
      { hash: 'checkboxes', label: 'GKCheckBoxes' },
      { hash: 'radiobuttons', label: 'GKRadioButtons' },
      { hash: 'togglebutton', label: 'GKToggleButton' },
      { hash: 'basicbutton', label: 'GKBasicButton' },
      { hash: 'labeledfieldset', label: 'GKLabeledFieldset' },
      { hash: 'tabui', label: 'GKTabUI' },
      { hash: 'slidedownui', label: 'GKSlideDownUi' },
      { hash: 'dropdownui', label: 'GKDropdownUi' },
      { hash: 'modalbox', label: 'GKModalBox' },
      { hash: 'misc', label: 'その他' },
    ],
  },
  {
    ...
    links    : [
      { hash: 'standard', label: 'GKStandardList' },
      { hash: 'rounded', label: 'GKRoundedList' },
      { hash: 'artistic', label: 'GKArtisticList' },
      { hash: 'tile', label: 'GKTileList' },
      { hash: 'simple', label: 'GKSimpleList' },
      { hash: 'row', label: 'GKRowList' },
      { hash: 'news', label: 'GKNewsList' },
      { hash: 'entertainment', label: 'GKEntertainmentList' },
      { hash: 'gallery', label: 'GKGalleryList' },
      { hash: 'grid', label: 'GKGridList' },
    ],
  },
]
